...
import services from '../api/DashboardService';
...
export const DashboardReducer = (
    ...
    switch (action.type) {
        case actionTypes.GET_RAINFALL : 
            return {
                ...state,
                rainfall : action?.payload?.data as IDashboardRainfall[],
            };
        case actionTypes.GET_MAX_TEMP : 
            return {
                ...state,
                max_temp :  action?.payload?.data as IDashboardRainfall[],
            };
        case actionTypes.GET_MEAN_TEMP : 
            return {
                ...state,
                mean_temp :  action?.payload?.data as IDashboardRainfall[],
            };
        case actionTypes.GET_MIN_TEMP : 
            return {
                ...state,
                min_temp : action?.payload?.data as IDashboardRainfall[],
            };
        default:
            return state;
    }
